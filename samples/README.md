...
# [Analytics Hub API: Node.js Samples](https://github.com/googleapis/nodejs-bigquery-data-exchange)
...
[Using the client library](https://github.com/googleapis/nodejs-bigquery-data-exchange#using-the-client-library).
