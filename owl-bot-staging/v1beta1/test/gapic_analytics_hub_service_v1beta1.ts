...
describe('v1beta1.AnalyticsHubServiceClient', () => {
    ...
    describe('getDataExchange', () => {
        it('invokes getDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetDataExchangeRequest', ['name']);
    ...
    describe('createDataExchange', () => {
        it('invokes createDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateDataExchangeRequest', ['parent']);
    ...
    describe('updateDataExchange', () => {
        it('invokes updateDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateDataExchangeRequest', ['dataExchange', 'name']);
    ...
    describe('deleteDataExchange', () => {
        it('invokes deleteDataExchange without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteDataExchangeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getListing', () => {
        it('invokes getListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetListingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createListing', () => {
        it('invokes createListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateListingRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.bigquery.dataexchange.v1beta1.Listing()
    ...
    describe('updateListing', () => {
        it('invokes updateListing without error', async () => {
            ...
            request.listing ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateListingRequest', ['listing', 'name']);
    ...
    describe('deleteListing', () => {
        it('invokes deleteListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteListingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('subscribeListing', () => {
        it('invokes subscribeListing without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SubscribeListingRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listDataExchanges', () => {
        it('invokes listDataExchanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDataExchangesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listOrgDataExchanges', () => {
        it('invokes listOrgDataExchanges without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListOrgDataExchangesRequest', ['organization']);
    ...
    describe('listListings', () => {
        it('invokes listListings without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListListingsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
